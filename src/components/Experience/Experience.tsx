      ...
      {experience.map((exp, index) => (
        <div key={index} className={styles.experienceItem}>
          <div className={styles.experienceItemHeader}>
            <div className={styles.experienceItemHeaderCompany}>{exp.company}</div>
            <div className={styles.experienceItemHeaderPeriod}>
              {exp.period}
            </div>
          </div>
          <div className={styles.experienceItemContent}>
            <div className={styles.experienceItemPosition}>{exp.position}</div>
            <ul className={styles.experienceItemResponsibilities}>
              {exp.responsibilities.map((resp, idx) => (
                <li key={idx} className={styles.experienceItemResponsibility}>
                  <span className={styles.experienceItemResponsibilityBullet}>-</span>
                  <span>{resp}</span>
                </li>
              ))}
            </ul>
